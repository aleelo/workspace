...
class Assigning_items extends Security_Controller {
    ...
    function index($tab = "") {
        ...
        return $this->template->rander("assigning_items/index", $view_data);
    }
    ...
    function modal_form() {
        ...
        return $this->template->view('assigning_items/modal_form', $view_data);
    }
    ...
    function save() {
        ...
        if ($save_id) {
            ...
            if(!$assign_item_id){
                ...
                $partner = $this->Assigning_items_model->get_details($options)->getRow();
    ...
    function delete() {
        ...
        if ($this->Assigning_items_model->delete($id)) {
    ...
    function list_data() {
        ...
        $result = $this->Assigning_items_model->get_details($all_options);
    ...
    private function _row_data($id) {
        ...
        $data = $this->Assigning_items_model->get_details($options)->getRow();
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $row_data[] = modal_anchor(get_uri("assigning_items/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_department'), "data-post-id" => $data->id))
                . js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_department'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("assigning_items/delete"), "data-action" => "delete-confirmation"));
    ...
    public function department_employee($deparment_id)
    {
        ...
        return $this->template->rander("assigning_items/department_employee", $view_data);
    }
    ...
    function view($Deparment_id = 0, $tab = "") {
        ...
        if ($Deparment_id) {
            ...
            $department_info = $this->Assigning_items_model->get_details($options)->getRow();
            if ($department_info && !$department_info->is_lead) {
                ...
                return $this->template->rander("assigning_items/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add") {
        if ($client_id) {
            ...
            if ($type === "add") {
                ...
                return $this->template->view('assigning_items/star/starred', $view_data);
            } else {
                $this->Clients_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                return $this->template->view('assigning_items/star/not_starred', $view_data);
            }
        }
    }
    ...
    function show_my_starred_clients() {
        ...
        return $this->template->view('assigning_items/star/clients_list', $view_data);
    }
    ...
    function projects($client_id) {
        ...
        return $this->template->view("assigning_items/projects/index", $view_data);
    }
    ...
    function payments($client_id) {
        ...
        if ($client_id) {
            ...
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("assigning_items/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("assigning_items/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("assigning_items/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("assigning_items/estimates/estimates", $view_data);
        }
    }
    ...
    function orders($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("assigning_items/orders/orders", $view_data);
        }
    }
    ...
    function estimate_requests($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("assigning_items/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("assigning_items/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "") {
        ...
        if ($view_type == "page_view") {
            ...
            return $this->template->rander("assigning_items/files/index", $view_data);
        } else {
            return $this->template->view("assigning_items/files/index", $view_data);
        }
    }
    ...
    function file_modal_form() {
        ...
        return $this->template->view('assigning_items/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data) {
        ...
        $description = "<div class='float-start'>" .
                js_anchor(remove_file_prefix($data->file_name), array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("assigning_items/view_file/" . $data->id)));
        ...
        $options = anchor(get_uri("assigning_items/download_file/" . $data->id), "<i data-feather='download-cloud' class='icon-16'></i>", array("title" => app_lang("download")));

        if ($this->login_user->user_type == "staff") {
            $options .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_file'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("assigning_items/delete_file"), "data-action" => "delete-confirmation"));
        }
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            return $this->template->view("assigning_items/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "") {
        ...
        if ($view_data['user_info']->user_type === "client") {
            ...
            return $this->template->rander("assigning_items/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences() {
        ...
        return $this->template->view("assigning_items/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($Deparment_id = 0) {
        ...
        return $this->template->view("assigning_items/contacts/index", $view_data);
    }
    ...
    function add_new_contact_modal_form() {
        ...
        return $this->template->view('assigning_items/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0) {
        if ($contact_id) {
            ...
            return $this->template->view('assigning_items/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($Deparment_id = 0) {
        if ($Deparment_id) {
            ...
            return $this->template->view('assigning_items/contacts/company_info_tab', $view_data);
        }
    }
    ...
    function save_contact() {
        ...
        $primary_contact = $this->Assigning_items_model->get_primary_contact($Deparment_id);
        if (!$primary_contact) {
    ...
    private function _make_contact_row($data, $custom_fields, $hide_primary_contact_label = false) {
        ...
        $contact_link = anchor(get_uri("assigning_items/contact_profile/" . $data->id), $full_name . $primary_contact) . $removal_request_pending;
        if ($this->login_user->user_type === "client") {
        ...
        $row_data = array(
            $user_avatar,
            $contact_link,
            anchor(get_uri("assigning_items/view/" . $data->Deparment_id), $client_info->company_name),
            $data->job_title,
            $data->email,
        ...
        $row_data[] = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_contact'), "class" => "delete", "data-id" => "$data->id", "data-action-url" => get_uri("assigning_items/delete_contact"), "data-action" => "delete"));
    ...
    function invitation_modal() {
        ...
        $view_data["client_info"] = $this->Clients_model->get_one($client_id);
        return $this->template->view('assigning_items/contacts/invitation_modal', $view_data);
    }
    ...
    function users() {
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->rander("assigning_items/contacts/users", $view_data);
        }
    }
    ...
    function import_clients_modal_form() {
        ...
        return $this->template->view("assigning_items/import_clients_modal_form");
    }
    ...
    function gdpr() {
        $view_data["user_info"] = $this->Users_model->get_one($this->login_user->id);
        return $this->template->view("assigning_items/contacts/gdpr", $view_data);
    }
    ...
    function request_my_account_removal() {
        if (get_setting("enable_gdpr") && get_setting("clients_can_request_account_removal")) {
            ...
            app_redirect("assigning_items/contact_profile/$user_id/gdpr");
        }
    }
    ...
    function expenses($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("assigning_items/expenses/index", $view_data);
        }
    }
    ...
    function contracts($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("assigning_items/contracts/contracts", $view_data);
        }
    }
    ...
    function proposals($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("assigning_items/proposals/proposals", $view_data);
        }
    }
    ...
    function tasks($client_id) {
        ...
        $view_data['client_id'] = clean_data($client_id);
        return $this->template->view("assigning_items/tasks/index", $view_data);
    }
}
