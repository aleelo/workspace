...
class Departments extends Security_Controller
{
    ...
    function save()
    {
        ...
        if ($id) {
            $this->db->query("update rise_departments set nameSo='$nameSo',short_name_SO='$short_name_SO',nameEn='$nameEn',short_name_EN='$short_name_EN',head_id='$head_id',email='$email',remarks='$remarks' where id='$id'");
            $save_id = $id;
        } else {
            $this->db->query("insert into rise_departments (nameSo,short_name_SO,nameEn,short_name_EN,head_id,email,remarks) values('$nameSo','$short_name_SO','$nameEn','$short_name_EN','$head_id','$email','$remarks')");
