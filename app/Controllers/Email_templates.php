        ...
        if (get_setting("module_appointment")) {
            $templates_array["appointment_email"] = [
                ...
                "appointment_approved_to_sectetary_email" => array("APPOINTMENT_ID", "APPOINTMENT_TITLE", "APPOINTMENT_DATE", "APPOINTMENT_TIME", 
                    "APPOINTMENT_ROOM", "APPOINTMENT_NOTE", "HOST_NAME", "SECRETARY_NAME", "HOST_DEPARTMENT", "APPOINTMENT_MEETING_WITH", "LOGO_URL", "SIGNATURE", "RECIPIENTS_EMAIL_ADDRESS"),
                "appointment_rejected_to_host_email" => array("APPOINTMENT_ID", "APPOINTMENT_TITLE", "APPOINTMENT_DATE", "APPOINTMENT_TIME", 
                    "APPOINTMENT_ROOM", "APPOINTMENT_NOTE", "APPOINTMENT_DECLINE_REASON", "HOST_NAME", "HOST_DEPARTMENT", "APPOINTMENT_MEETING_WITH", "LOGO_URL", "SIGNATURE", "RECIPIENTS_EMAIL_ADDRESS"),
                "appointment_rejected_to_sectetary_email" => array("APPOINTMENT_ID", "APPOINTMENT_TITLE", "APPOINTMENT_DATE", "APPOINTMENT_TIME", 
                    "APPOINTMENT_ROOM", "APPOINTMENT_NOTE", "APPOINTMENT_DECLINE_REASON", "HOST_NAME", "SECRETARY_NAME", "HOST_DEPARTMENT", "APPOINTMENT_MEETING_WITH", "LOGO_URL", "SIGNATURE", "RECIPIENTS_EMAIL_ADDRESS"),
            ];
        }
