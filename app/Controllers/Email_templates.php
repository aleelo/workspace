        ...
        if (get_setting("module_appointment")) {
            ...
            $templates_array["appointment_email"] = [
                ...
                "appointment_created_to_host_email" => array("APPOINTMENT_ID", "APPOINTMENT_TITLE", "APPOINTMENT_DATE", "APPOINTMENT_TIME", 
                    "APPOINTMENT_ROOM", "APPOINTMENT_NOTE", "APPOINTMENT_MEETING_WITH", "APPOINTMENT_DECLINE_REASON", "HOST_NAME", "HOST_DEPARTMENT", 
                    "REGARD_NAME", "REGARD_POSITION", "SECRETARY_NAME", "PARTICIPANT_NAME", "MEETING_WITH_NAMES", 
                    "LOGO_URL", "SIGNATURE", "RECIPIENTS_EMAIL_ADDRESS"),
