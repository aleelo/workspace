...
class Email_templates extends Security_Controller {
    ...
    private function _templates() {
        ...
        $templates_array["employee"] = array(
            ...
            "leave_request_verified" => array("LEAVE_ID", "LEAVE_TITLE", "EMPLOYEE_NAME",  "LEAVE_URL","LEAVE_DATE","TOTAL_DAYS", "LOGO_URL", "SIGNATURE", "LEAVE_STATUS","EMAIL_HEADER_URL","EMAIL_FOOTER_URL"),
            "leave_request_approved" => array("LEAVE_ID", "LEAVE_TITLE", "EMPLOYEE_NAME",  "LEAVE_URL","LEAVE_DATE","TOTAL_DAYS", "LOGO_URL", "SIGNATURE", "LEAVE_STATUS","EMAIL_HEADER_URL","EMAIL_FOOTER_URL"),
            "leave_request_rejected" => array("LEAVE_ID", "LEAVE_TITLE", "EMPLOYEE_NAME",  "LEAVE_URL","LEAVE_DATE","TOTAL_DAYS", "LOGO_URL", "SIGNATURE", "LEAVE_STATUS","EMAIL_HEADER_URL","EMAIL_FOOTER_URL"),
        );
