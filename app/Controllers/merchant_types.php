...
class Merchant_types extends Security_Controller {
    ...
    private function _make_row($data) {
        return array(
            ...
            $data->merchant_type,
            modal_anchor(get_uri("merchant_types/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_bank_name'), "data-post-id" => $data->id))
            . js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_bank_name'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("merchant_types/delete"), "data-action" => "delete"))
