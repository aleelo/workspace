...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <?php echo view("appointments/decline_reason_field"); ?>
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-danger"><span data-feather="check-circle" class="icon-16"></span> <?php echo app_lang('decline'); ?></button>
</div>
<?php echo form_close(); ?>
