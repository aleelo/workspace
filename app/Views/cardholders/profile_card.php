<div id="page-content" class="page-wrapper clearfix">
    <div class="page-title clearfix mb20 no-border rounded">
        ...
        <div class="title-button-group">
            <?php
            echo anchor(get_uri("cardholders"), '<i data-feather="menu" class="icon-16"></i>', array("class" => "btn btn-default btn-sm me-0", "title" => app_lang('list_view')));
        ...
        <?php foreach ($cardholders as $cardholder) { ?>
            <div class="col-md-3 col-sm-6">
                <div class="card  text-center ">
                    <div class="card-body">
                        <span class="avatar avatar-md mt15"><img src="<?php echo get_avatar($cardholder->photo); ?>" alt="..."></span> 
                        <h4><?php echo $cardholder->fullName; ?></h4>
                        <p class="text-off"><?php echo $cardholder->titleEng ? $cardholder->titleEng : "Untitled"; ?></p>
                    </div>
                    <div class="card-footer bg-info p15 no-border">
                        <?php echo get_team_member_profile_link($cardholder->id, app_lang("view_details"), array("class" => "btn btn-xs btn-info text-white")); ?>
                    </div>
                </div>
            </div>
        <?php } ?>
