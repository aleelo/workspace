...
<script type="text/javascript">
    ...
    var quick_filters_dropdown = <?php echo view("compliance/quick_filters_dropdown"); ?>;
    ...
    $(selector).appTable({
    source: '<?php echo_uri("compliance/list_data") ?>',
            serverSide: true,
...
<?php echo $custom_field_filters; ?>
            ...
            {title: "<?php echo app_lang("reporter") ?>", "class": "all", order_by: "reporter"},
            {title: "<?php echo app_lang("report") ?>", order_by: "report"},
            {title: "<?php echo app_lang("evidence") ?>", order_by: "evidence"}
