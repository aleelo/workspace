...
if ($tab == "projects") {
    ...
    if ($view_type == "client_dashboard") {
        ...
        $link = get_uri('edeclaration_10k/view/' . $client_info->id . '/projects');
    }
    ...
    if ($view_type == "client_dashboard") {
        ...
        $link = get_uri('edeclaration_10k/view/' . $client_info->id . '/invoices');
    }
    ...
    if ($view_type == "client_dashboard") {
        ...
        $link = get_uri('edeclaration_10k/view/' . $client_info->id . '/payments');
    }
} else if ($tab == "due") {
    $card = "bg-coral";
    $icon = "compass";
