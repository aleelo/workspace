...
<script type="text/javascript">
    ...
    var quick_filters_dropdown = <?php echo view("edeclaration_10k/quick_filters_dropdown"); ?>;
    ...
    $(selector).appTable({
    source: '<?php echo_uri("edeclaration_10k/edeclaration_10k_arrival_list_data") ?>',
            serverSide: true,
