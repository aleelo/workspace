<?php echo form_open(get_uri("edeclaration_10k/save"), array("id" => "client-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="ticket_id" value="<?php echo $ticket_id; ?>" />
        <?php echo view("edeclaration_10k/section_form_fields"); ?>
...
<div class="modal-footer">
    <div id="link-of-add-contact-modal" class="hide">
        <?php echo modal_anchor(get_uri("edeclaration_10k/add_new_contact_modal_form"), "", array()); ?>
    </div>
