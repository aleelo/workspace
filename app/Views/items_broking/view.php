    ...
    <div class="container-fluid  full-width-button">
        <div class="row clients-view-button">
            <div class="col-md-12">
                <div class="page-title clearfix no-border no-border-top-radius no-bg">
                    <h1 class="pl0">
                        ...
                        <span id="star-mark">
                            <?php
                            if ($is_starred) {
                                echo view('items_broking/star/starred', array("client_id" => $department_info->id));
                            } else {
                                echo view('items_broking/star/not_starred', array("client_id" => $department_info->id));
                            }
                            ?>
                        </span>
                ...
                <div>
                    <?php// echo view("items_broking/info_widgets/index"); ?>
                </div>

                <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs" role="tablist">
                    
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("items_broking/company_info_tab/" . $department_info->id); ?>" data-bs-target="#departments-info"> <?php echo app_lang('department_info'); ?></a></li>
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("items_broking/department_employee/" . $department_info->id); ?>" data-bs-target="#department-employee-list"> <?php echo app_lang('employee_list'); ?></a></li>
