...
if ($tab == "projects") {
    ...
    if ($view_type == "client_dashboard") {
        ...
        $link = get_uri('items_list/view/' . $department_info->id . '/projects');
    }
    ...
    if ($view_type == "client_dashboard") {
        ...
        $link = get_uri('items_list/view/' . $department_info->id . '/invoices');
    }
    ...
    if ($view_type == "client_dashboard") {
        ...
        $link = get_uri('items_list/view/' . $department_info->id . '/payments');
    }
} else if ($tab == "due") {
    $card = "bg-coral";
    $icon = "compass";
