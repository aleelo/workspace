<div id="page-content" class="page-wrapper clearfix grid-button leads-view">
    <ul class="nav nav-tabs bg-white title" role="tablist">
        <li class="title-tab leads-title-section"><h4 class="pl15 pt10 pr15"><?php echo app_lang("fuel_receive"); ?></h4></li>
        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                ...
                <?php echo modal_anchor(get_uri("fuel/receive_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_fuel_receive'), array("class" => "btn btn-default", "title" => app_lang('add_fuel_receive'))); ?>
            </div>
        </div>
    </ul>
    ...
    <div class="card">
        <div class="table-responsive">
            <table id="receive-table" class="display" cellspacing="0" width="100%">            
            </table>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $("#receive-table").appTable({
    source: '<?php echo_uri("fuel/list_data") ?>',
            serverSide: true,
