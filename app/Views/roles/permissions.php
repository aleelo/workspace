            ...
            <?php if ($login_user->is_admin) { ?>
                ...
                <li>
                    ...
                    <div id="individual_team_members_permission_area" class="<?php echo $hide_team_members_list ? "hide" : ""; ?>">
                        <div class="ml20">
                            <label for="can_manage"><?php echo app_lang("can_manage_employees"); ?></label>
                            <div class="ml10">
                                <div>
                                    <?php
                                    if (is_null($can_manage_employee_for)) {
                                        $can_manage_employee_for = "";
                                    }
                                    echo form_radio(array(
                                        "id" => "can_manage_employee_for_no",
                                        "name" => "can_manage_employee_for",
                                        "value" => "",
                                        "class" => "can_manage_employee_for toggle_specific form-check-input",
                                            ), $can_manage_employee_for, ($can_manage_employee_for === "") ? true : false);
                                    ?>
                                    <label for="can_manage_employee_for_no"><?php echo app_lang("no"); ?></label>
                                </div>
                                <div>
                                    <?php
                                    echo form_radio(array(
                                        "id" => "can_manage_employee_for_own_unit",
                                        "name" => "can_manage_employee_for",
                                        "value" => "own_unit",
                                        "class" => "can_manage_employee_for toggle_specific form-check-input",
                                            ), $can_manage_employee_for, ($can_manage_employee_for === "own_unit") ? true : false);
                                    ?>
                                    <label for="can_manage_employee_for_own_unit"><?php echo app_lang("own_unit_employees"); ?></label>
                                </div>
                                <div>
                                    <?php
                                    echo form_radio(array(
                                        "id" => "can_manage_employee_for_own_section",
                                        "name" => "can_manage_employee_for",
                                        "value" => "own_section",
                                        "class" => "can_manage_employee_for toggle_specific form-check-input",
                                            ), $can_manage_employee_for, ($can_manage_employee_for === "own_section") ? true : false);
                                    ?>
                                    <label for="can_manage_employee_for_own_section"><?php echo app_lang("own_section_employees"); ?></label>
                                </div>
                                <div>
                                    <?php
                                    echo form_radio(array(
                                        "id" => "can_manage_employee_for_own_department",
                                        "name" => "can_manage_employee_for",
                                        "value" => "own_department",
                                        "class" => "can_manage_employee_for toggle_specific form-check-input",
                                            ), $can_manage_employee_for, ($can_manage_employee_for === "own_department") ? true : false);
                                    ?>
                                    <label for="can_manage_employee_for_own_department"><?php echo app_lang("own_department_employees"); ?></label>
                                </div>
                                <div>
                                    <?php
                                    echo form_radio(array(
                                        "id" => "can_manage_employee_for_all",
                                        "name" => "can_manage_employee_for",
                                        "value" => "all",
                                        "class" => "can_manage_employee_for toggle_specific form-check-input",
                                            ), $can_manage_employee_for, ($can_manage_employee_for === "all") ? true : false);
                                    ?>
                                    <label for="can_manage_employee_for_all"><?php echo app_lang("all"); ?></label>
                                </div>
                            </div>
                        </div>
                        <div>
                ...
                <?php if (get_setting("module_project")) { ?>
                        <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                            <h5><?php echo app_lang("can_manage_projects"); ?></h5>
                            <div>
                                <div>
                                    ...
                                    <div>
                                        ...
                                        echo form_radio(array(
                                            ...
                                            "value" => "",
                                            "class" => "project_permission toggle_specific form-check-input",
                                                ), $project, ($project === "") ? true : false);
                                        ?>
                                        <label for="project_no"><?php echo app_lang("no"); ?></label>
                                    </div>
                                    <div>
                                        <?php
                                        echo form_radio(array(
                                            ...
                                            "value" => "own",
                                            "class" => "project_permission toggle_specific form-check-input",
                                                ), $project, ($project === "own") ? true : false);
                                        ?>
                                        <label for="project_yes_own"><?php echo app_lang("yes_own_projects"); ?></label>
                                    </div>
                                    <div>
                                        <?php
                                        echo form_radio(array(
                                            ...
                                            "value" => "all",
                                            "class" => "project_permission toggle_specific form-check-input",
                                                ), $project, ($project === "all") ? true : false);
                                        ?>
                                        <label for="project_yes_all"><?php echo app_lang("yes_all_projects"); ?></label>
                                    </div>
                ...
                <?php if (get_setting("module_task")) { ?>
                        <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                            <h5><?php echo app_lang("can_manage_tasks"); ?></h5>
                            <div>
                                <div>
                                    ...
                                    <div>
                                        ...
                                        echo form_radio(array(
                                            ...
                                            "value" => "",
                                            "class" => "task_permission toggle_specific form-check-input",
                                    ...
                                    <div>
                                        ...
                                        echo form_radio(array(
                                            ...
                                            "value" => "own",
                                            "class" => "task_permission toggle_specific form-check-input",
                                                ), $task, ($task === "own") ? true : false);
                                        ?>
                                        <label for="task_yes_own"><?php echo app_lang("yes_own_tasks"); ?></label>
                                    </div>
                                    <div>
                                        <?php
                                        echo form_radio(array(
                                        ...
                                        ?>
                                        <label for="task_yes_all"><?php echo app_lang("yes_all_tasks"); ?></label>
                                    </div>
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            echo form_radio(array(
                                ...
                                "value" => "",
                                "class" => "event_permission toggle_specific form-check-input",
                                    ), $event, ($event === "") ? true : false);
                            ?>
                            <label for="event_no"><?php echo app_lang("no"); ?></label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "own",
                                "class" => "event_permission toggle_specific form-check-input",
                                    ), $event, ($event === "own") ? true : false);
                            ?>
                            <label for="event_yes_own"><?php echo app_lang("yes_own_events"); ?></label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "all",
                                "class" => "event_permission toggle_specific form-check-input",
                                    ), $event, ($event === "all") ? true : false);
                            ?>
                            <label for="event_yes_all"><?php echo app_lang("yes_all_events"); ?></label>
                        </div>
                    </li>
                <?php } ?>
                        ...
                        <div>
                            <div>
                                <div>
                                    ...
                                    ?>
                                    <label for="document_no"><?php echo app_lang("no"); ?></label>
                                </div>
                                <div>
                                    <?php
                                    echo form_radio(array(
                                ...
                                <div>
                                    ...
                                    echo form_radio(array(
                                        ...
                                        "value" => "own_unit",
                                        "class" => "document_permission toggle_specific form-check-input",
                                            ), $document, ($document === "own_unit") ? true : false);
                                    ?>
                                    <label for="document_yes_own_unit"><?php echo app_lang("yes_own_unit_documents"); ?></label>
                                </div>
                                <div>
                                    <?php
                                    echo form_radio(array(
                                        "id" => "document_yes_own_section",
                                        "name" => "document_permission",
                                        "value" => "own_section",
                                        "class" => "document_permission toggle_specific form-check-input",
                                            ), $document, ($document === "own_section") ? true : false);
                                    ?>
                                    <label for="document_yes_own_section"><?php echo app_lang("yes_own_section_documents"); ?></label>
                                </div>
                                <div>
                                    <?php
                                    echo form_radio(array(
                                        "id" => "document_yes_own_department",
                                        "name" => "document_permission",
                                        "value" => "own_department",
                                        "class" => "document_permission toggle_specific form-check-input",
                                            ), $document, ($document === "own_department") ? true : false);
                                    ?>
                                    <label for="document_yes_own_department"><?php echo app_lang("yes_own_department_documents"); ?></label>
                                </div>
                                <div>
                                    <?php
                                    echo form_radio(array(
                                        ...
                                        "value" => "all",
                                        "class" => "document_permission toggle_specific form-check-input",
                                            ), $document, ($document === "all") ? true : false);
                                    ?>
                                    <label for="document_yes_all"><?php echo app_lang("yes_all_documents"); ?></label>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="ml20">
                ...
                <?php if (get_setting("module_edeclaration")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_manage_edeclaration"); ?> <span class="help" data-bs-toggle="tooltip" title="Hides all information of edeclarations except company name."><i data-feather="help-circle" class="icon-14"></i></span></h5>
                        <div>
                            <?php
                            if (is_null($edeclaration)) {
                                $edeclaration = "";
                            }
                            echo form_radio(array(
                                "id" => "edeclaration_no",
                                "name" => "edeclaration_permission",
                                "value" => "",
                                "class" => "edeclaration_permission toggle_specific form-check-input",
                                    ), $edeclaration, ($edeclaration === "") ? true : false);
                            ?>
                            <label for="edeclaration_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "edeclaration_yes_all",
                                "name" => "edeclaration_permission",
                                "value" => "all",
                                "class" => "edeclaration_permission toggle_specific form-check-input",
                                    ), $edeclaration, ($edeclaration === "all") ? true : false);
                            ?>
                            <label for="edeclaration_yes_all"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>
