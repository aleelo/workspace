<div id="page-content" class="page-wrapper clearfix">
    <div class="clearfix grid-button">
        <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("sections/sections_list/"); ?>" data-bs-target="#clients_list"><?php echo app_lang('sections_list'); ?></a></li>
            ...
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    ...
                    if ($can_edit_clients) {
                        ...
                        // echo modal_anchor(get_uri("sections/import_clients_modal_form"), "<i data-feather='upload' class='icon-16'></i> " . app_lang('import_clients'), array("class" => "btn btn-default", "title" => app_lang('import_clients')));
