...
<script>
    $(document).ready(function () {
        ...
        var dropdowns = {};
        dropdowns.employees_dropdown = <?php echo json_encode($employees_dropdown); ?>;
        dropdowns.departments_dropdown = <?php echo json_encode($departments_dropdown); ?>;
        dropdowns.sections_dropdown = <?php echo json_encode($sections_dropdown); ?>;
        dropdowns.units_dropdown = <?php echo json_encode($units_dropdown); ?>;
