        ...
        <div class="row clients-view-button">
            <div class="col-md-12">
                <div class="page-title clearfix no-border no-border-top-radius no-bg">
                    <h1 class="pl0">
                        ...
                        <span id="star-mark">
                            <?php
                            if ($is_starred) {
                                echo view('training/star/starred', array("client_id" => $section_info->id));
                            } else {
                                echo view('training/star/not_starred', array("client_id" => $section_info->id));
                            }
                            ?>
                        </span>
                ...
                <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs" role="tablist">
                    ...
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/company_info_tab/" . $section_info->id); ?>" data-bs-target="#client-info"> <?php echo app_lang('unit_info'); ?></a></li>

                    <!-- <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/contacts/" . $section_info->id); ?>" data-bs-target="#client-contacts"> <?php echo app_lang('contacts'); ?></a></li>

                    <?php if ($show_project_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/projects/" . $section_info->id); ?>" data-bs-target="#client-projects"><?php echo app_lang('projects'); ?></a></li>
                    <?php } ?>

                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/tasks/" . $section_info->id); ?>" data-bs-target="#client-tasks"><?php echo app_lang('tasks'); ?></a></li> -->

                    <!-- <?php if ($show_invoice_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/invoices/" . $section_info->id); ?>" data-bs-target="#client-invoices"> <?php echo app_lang('invoices'); ?></a></li>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/payments/" . $section_info->id); ?>" data-bs-target="#client-payments"> <?php echo app_lang('payments'); ?></a></li>
                    <?php } ?> -->

                    <?php if ($show_estimate_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/estimates/" . $section_info->id); ?>" data-bs-target="#client-estimates"> <?php echo app_lang('estimates'); ?></a></li>
                    <?php } ?>

                    <!-- <?php if ($show_order_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/orders/" . $section_info->id); ?>" data-bs-target="#client-orders"> <?php echo app_lang('orders'); ?></a></li>
                    <?php } ?> -->

                    <!-- <?php if ($show_estimate_request_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/estimate_requests/" . $section_info->id); ?>" data-bs-target="#client-estimate-requests"> <?php echo app_lang('estimate_requests'); ?></a></li>
                    <?php } ?>
                    <?php if ($show_contract_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/contracts/" . $section_info->id); ?>" data-bs-target="#client-contracts"> <?php echo app_lang('contracts'); ?></a></li>
                    <?php } ?>
                    <?php if ($show_proposal_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/proposals/" . $section_info->id); ?>" data-bs-target="#client-proposals"> <?php echo app_lang('proposals'); ?></a></li>
                    <?php } ?> -->

                    <!-- <?php if ($show_ticket_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/tickets/" . $section_info->id); ?>" data-bs-target="#client-tickets"> <?php echo app_lang('tickets'); ?></a></li>
                    <?php } ?>
                    <?php if ($show_note_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/notes/" . $section_info->id); ?>" data-bs-target="#client-notes"> <?php echo app_lang('notes'); ?></a></li>
                    <?php } ?>
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/files/" . $section_info->id); ?>" data-bs-target="#client-files"><?php echo app_lang('files'); ?></a></li> -->

                    <!-- <?php if ($show_event_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/events/" . $section_info->id); ?>" data-bs-target="#client-events"> <?php echo app_lang('events'); ?></a></li>
                    <?php } ?>

                    <?php if ($show_expense_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("training/expenses/" . $section_info->id); ?>" data-bs-target="#client-expenses"> <?php echo app_lang('expenses'); ?></a></li>
                    <?php } ?> -->
