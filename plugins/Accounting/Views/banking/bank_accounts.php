<div class="card">
    <div class="page-title clearfix">
        <div class="title-button-group">
            <a href="#" class="btn btn-default add-new-account mbot15 <?php if(!acc_has_permission('acc_can_create_banking')){echo 'hide';} ?>"><i data-feather="plus-circle" class="icon-16"></i> <?php echo _l('add'); ?></a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <?php echo render_select('account_type_id',$account_types,array('id','name'),'account_type','3',array('disabled' => true),array(),'','',false); ?>
