<div id="page-content" class="page-wrapper clearfix">
    ...
    <div class="card">
        ...
        <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                      <label for="customer" class=""><?php echo app_lang('customer'); ?></label>
                      <?php
                          echo form_dropdown("customer", $customers_dropdown, array(), "class='select2 validate-hidden' id='customer'");
                          ?>
                  </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3 mt-1">
                  <?php echo form_hidden('type', 'customer_statement'); ?>
          ...
          <div class="page row" id="DivIdToPrint">
        </div>
      </div>
    </div>
  </div>
