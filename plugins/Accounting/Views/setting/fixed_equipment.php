<?php 
  ...
  $acc_fe_asset_automatic_conversion = get_setting('acc_fe_asset_automatic_conversion');
  $acc_fe_asset_payment_account = get_setting('acc_fe_asset_payment_account');
  $acc_fe_asset_deposit_to = get_setting('acc_fe_asset_deposit_to');

  $acc_fe_license_automatic_conversion = get_setting('acc_fe_license_automatic_conversion');
  $acc_fe_license_payment_account = get_setting('acc_fe_license_payment_account');
  $acc_fe_license_deposit_to = get_setting('acc_fe_license_deposit_to');

  $acc_fe_component_automatic_conversion = get_setting('acc_fe_component_automatic_conversion');
  $acc_fe_component_payment_account = get_setting('acc_fe_component_payment_account');
  $acc_fe_component_deposit_to = get_setting('acc_fe_component_deposit_to');

  $acc_fe_consumable_automatic_conversion = get_setting('acc_fe_consumable_automatic_conversion');
  $acc_fe_consumable_payment_account = get_setting('acc_fe_consumable_payment_account');
  $acc_fe_consumable_deposit_to = get_setting('acc_fe_consumable_deposit_to');

  $acc_fe_asset_automatic_conversion = get_setting('acc_fe_asset_automatic_conversion');
  $acc_fe_asset_payment_account = get_setting('acc_fe_asset_payment_account');
  $acc_fe_asset_deposit_to = get_setting('acc_fe_asset_deposit_to');

  $acc_fe_maintenance_automatic_conversion = get_setting('acc_fe_maintenance_automatic_conversion');
  $acc_fe_maintenance_payment_account = get_setting('acc_fe_maintenance_payment_account');
  $acc_fe_maintenance_deposit_to = get_setting('acc_fe_maintenance_deposit_to');

  $acc_fe_depreciation_automatic_conversion = get_setting('acc_fe_depreciation_automatic_conversion');
  $acc_fe_depreciation_payment_account = get_setting('acc_fe_depreciation_payment_account');
  $acc_fe_depreciation_deposit_to = get_setting('acc_fe_depreciation_deposit_to');
 ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_fe_asset_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_fe_asset_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_fe_asset_automatic_conversion">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_fe_license_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_fe_license_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_fe_license_automatic_conversion">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_fe_component_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_fe_component_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_fe_component_automatic_conversion">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_fe_consumable_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_fe_consumable_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_fe_consumable_automatic_conversion">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_fe_maintenance_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_fe_maintenance_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_fe_maintenance_automatic_conversion">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_fe_depreciation_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_fe_depreciation_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_fe_depreciation_automatic_conversion">
...
<hr>
<button type="submit" class="btn btn-info pull-right <?php if(!acc_has_permission('acc_can_edit_setting')){echo 'hide';} ?>"><?php echo _l('submit'); ?></button>
<?php echo form_close(); ?>
