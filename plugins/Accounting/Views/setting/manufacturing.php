<?php 
  ...
  $acc_mrp_manufacturing_order_automatic_conversion = get_setting('acc_mrp_manufacturing_order_automatic_conversion');
  
  $acc_mrp_material_cost_payment_account = get_setting('acc_mrp_material_cost_payment_account');
  $acc_mrp_material_cost_deposit_to = get_setting('acc_mrp_material_cost_deposit_to');
  $acc_mrp_labour_cost_payment_account = get_setting('acc_mrp_labour_cost_payment_account');
  $acc_mrp_labour_cost_deposit_to = get_setting('acc_mrp_labour_cost_deposit_to');
 ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_mrp_manufacturing_order_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_mrp_manufacturing_order_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_mrp_manufacturing_order_automatic_conversion">
