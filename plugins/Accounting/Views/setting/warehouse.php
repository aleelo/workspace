<?php 
  ...
  $acc_wh_stock_import_automatic_conversion = get_setting('acc_wh_stock_import_automatic_conversion');
  $acc_wh_stock_import_payment_account = get_setting('acc_wh_stock_import_payment_account');
  $acc_wh_stock_import_deposit_to = get_setting('acc_wh_stock_import_deposit_to');

  $acc_wh_stock_export_automatic_conversion = get_setting('acc_wh_stock_export_automatic_conversion');
  $acc_wh_stock_export_payment_account = get_setting('acc_wh_stock_export_payment_account');
  $acc_wh_stock_export_deposit_to = get_setting('acc_wh_stock_export_deposit_to');

  $acc_wh_loss_adjustment_automatic_conversion = get_setting('acc_wh_loss_adjustment_automatic_conversion');
  $acc_wh_decrease_payment_account = get_setting('acc_wh_decrease_payment_account');
  $acc_wh_decrease_deposit_to = get_setting('acc_wh_decrease_deposit_to');
  $acc_wh_increase_payment_account = get_setting('acc_wh_increase_payment_account');
  $acc_wh_increase_deposit_to = get_setting('acc_wh_increase_deposit_to');

  $acc_wh_opening_stock_automatic_conversion = get_setting('acc_wh_opening_stock_automatic_conversion');
  $acc_wh_opening_stock_payment_account = get_setting('acc_wh_opening_stock_payment_account');
  $acc_wh_opening_stock_deposit_to = get_setting('acc_wh_opening_stock_deposit_to');
 ?>
...
<?php echo form_open(admin_url('accounting/update_warehouse_automatic_conversion'),array('id'=>'werehouse-mapping-setup-form', 'class' => 'general-form')); ?>
<div class="row">
  <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_wh_stock_import_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_wh_stock_import_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_wh_stock_import_automatic_conversion">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_wh_stock_export_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_wh_stock_export_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_wh_stock_export_automatic_conversion">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_wh_loss_adjustment_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_wh_loss_adjustment_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_wh_loss_adjustment_automatic_conversion">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-6 mtop5">
                  <div class="onoffswitch">
                      <input type="checkbox" id="acc_wh_opening_stock_automatic_conversion" data-perm-id="3" class="form-check-input" <?php if($acc_wh_opening_stock_automatic_conversion == '1'){echo 'checked';} ?>  value="1" name="acc_wh_opening_stock_automatic_conversion">
