...
<a href="#" onclick="loss_adjustment_transaction_bulk_actions(); return false;" data-toggle="modal" data-target="#loss_adjustment_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-loss-adjustment"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-loss-adjustment">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="loss-adjustment" class="form-check-input"><label></label></div></th>
...
<div class="modal fade bulk_actions" id="loss_adjustment_bulk_actions" tabindex="-1" role="dialog" data-table=".table-loss-adjustment">
   <div class="modal-dialog" role="document">
      ...
      <div class="modal-footer">
          ...
          <a type="submit" onclick="loss_adjustment_bulk_action(this); return false;" class="btn btn-info btn-submit text-white"><i data-feather="check-circle" class="icon-16"></i> <?php echo app_lang('confirm'); ?></a>
      </div>
   </div>
   <!-- /.modal-content -->
</div>
...
<!-- /.modal -->
<?php require 'plugins/Accounting/assets/js/transaction/loss_adjustment_js.php';?>
