...
<a href="#" onclick="opening_stock_transaction_bulk_actions(); return false;" data-toggle="modal" data-target="#opening_stock_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-opening-stock"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-opening-stock">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="opening-stock" class="form-check-input"><label></label></div></th>
...
<div class="modal fade bulk_actions" id="opening_stock_bulk_actions" tabindex="-1" role="dialog" data-table=".table-stock-export">
   <div class="modal-dialog" role="document">
      ...
      <div class="modal-footer">
          ...
          <a type="submit" onclick="opening_stock_bulk_action(this); return false;" class="btn btn-info btn-submit text-white"><i data-feather="check-circle" class="icon-16"></i> <?php echo app_lang('confirm'); ?></a>
      </div>
   </div>
   <!-- /.modal-content -->
</div>
...
<!-- /.modal -->
<?php require 'plugins/Accounting/assets/js/transaction/opening_stock_js.php';?>
