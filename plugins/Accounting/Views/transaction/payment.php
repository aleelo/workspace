<div class="row general-form">
	<div class="col-md-3">
       <?php echo render_select('payment_methods',$payment_methods,array('id','title'),'payment_methods', '', array('multiple' => true, 'data-actions-box' => true), array(), '', '', false); ?>
  </div>
  <div class="col-md-3">
    <?php $status = [ 
...
<a href="#" onclick="payments_transaction_bulk_actions(); return false;" data-toggle="modal" data-table=".table-payments" data-target="#payments_bulk_actions" class=" hide bulk-actions-btn table-btn"><?php echo _l('bulk_actions'); ?></a>

<table class="table table-payments">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="payments" class="form-check-input"><label></label></div></th>
...
<div class="modal fade bulk_actions" id="payments_bulk_actions" tabindex="-1" role="dialog" data-table=".table-payments">
   <div class="modal-dialog" role="document">
      ...
      <div class="modal-footer">
          ...
          <a type="submit" onclick="payments_bulk_action(this); return false;" class="btn btn-info btn-submit text-white"><i data-feather="check-circle" class="icon-16"></i> <?php echo app_lang('confirm'); ?></a>
      </div>
   </div>
   <!-- /.modal-content -->
</div>
