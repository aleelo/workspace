<div class="card">
    <div class="clearfix">
        <ul id="transaction-sale-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs rounded classic mb20 scrollable-tabs" role="tablist">
            ...
            <li>
                <a role="presentation" href="<?php echo get_uri('accounting/transaction?group=sales&tab=payment'); ?>" data-bs-target="#transaction_payments"><?php echo app_lang('payment'); ?> <span class="text-danger"><?php echo '('.$count_payment.')'; ?></span></a></li>
        ...
        <div class="tab-content p-3">
            <div role="tabpanel" class="tab-pane fade active" id="transaction_payments">
               <?php  echo view('Accounting\Views\transaction/payment'); ?>
            </div>
