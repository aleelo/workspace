...
<a href="#" onclick="stock_export_transaction_bulk_actions(); return false;" data-toggle="modal" data-target="#stock_export_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-stock-export"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-stock-export">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="stock-export" class="form-check-input"><label></label></div></th>
...
<div class="modal fade bulk_actions" id="stock_export_bulk_actions" tabindex="-1" role="dialog" data-table=".table-stock-export">
   <div class="modal-dialog" role="document">
      ...
      <div class="modal-footer">
          ...
          <a type="submit" onclick="stock_export_bulk_action(this); return false;" class="btn btn-info btn-submit text-white"><i data-feather="check-circle" class="icon-16"></i> <?php echo app_lang('confirm'); ?></a>
      </div>
   </div>
   <!-- /.modal-content -->
</div>
...
<!-- /.modal -->
<?php require 'plugins/Accounting/assets/js/transaction/stock_export_js.php';?>
