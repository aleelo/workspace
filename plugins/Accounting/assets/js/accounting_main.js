...
function initDataTable(selector, url, notsearchable, notsortable, fnserverparams, defaultorder, addClassCol) {
	"use strict";
	...
	var dtSettings = {
		...
		"columnDefs": [{
			...
			"sortable": false,
			"targets": notsortable
		},{ "className": " text-center option w100", "targets": addClassCol }],
